                ...
                <div className="form-content">
                    <div className="upper-content">
                        <div className="field-container">
                            ...
                            <input type="text" className={`username-input h-2 br brad-1 ${error.field === "username" || error.field === "all" ? "error" : ""}`} />
                            {error && (error.field === "username" || error.field === "all") ? <span className="error-message">{error.errorMessage}</span> : null}
                        </div>
                        <div className="field-container">
                            <label htmlFor="email" className="st-c">Email</label>
                            <input type="email" className={`email-input h-2 br brad-1 ${error.field === "email" || error.field === "all" ? "error" : ""}`} />
                            {error && error.field === "email" ? <span className="error-message">{error.errorMessage}</span> : null}
                        </div>
                        <div className="field-container">
                        ...
                        <div className="field-container">
                            <label htmlFor="repeat-passowrd" className="st-c">Repeat password</label>
                            <input type="password" className={`repeat-password-input h-2 br brad-1 ${error.field === "repeatPassword" || error.field === "all" ? "error" : ""}`} />
                            {error && error.field === "repeatPassword" ? <span className="error-message">{error.errorMessage}</span> : null}
                        </div>
                    ...
                    <div className="lower-content">
                        <button className="submit-button h-2 brad-1 btn-bgc lt-c">Create account</button>
                    </div>
                </div>
            </div>
        </div>
