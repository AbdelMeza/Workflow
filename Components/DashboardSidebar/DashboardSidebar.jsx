...
export default function DashboardSidebar() {
    ...
    const navigationLinks = [
        {
            ...
            active: path === "/dashboard/requests" ? true : false
        }, {
            icon: <><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
    ...
    return <div className="dashboard-side-bar bgc-lv1">
        ...
        <div className="settings-container">
            <div className={`setting-item mt-c s-fs h-2 brad-1 gap-2 ${path === "/dashboard/settings" ? "active" : ""}`} onClick={() => navigate("/dashboard/settings")}>
                <div className="icon">
